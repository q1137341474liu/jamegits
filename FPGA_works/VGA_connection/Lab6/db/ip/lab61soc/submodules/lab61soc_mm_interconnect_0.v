...
module lab61soc_mm_interconnect_0 (
	...
	wire  [106:0] hex_digits_s1_agent_rf_source_data;                                                 // hex_digits_s1_agent:rf_source_data -> hex_digits_s1_agent_rsp_fifo:in_data
	...
	wire  [106:0] hex_digits_s1_agent_rsp_fifo_out_data;                                              // hex_digits_s1_agent_rsp_fifo:out_data -> hex_digits_s1_agent:rf_sink_data
	...
	wire          cmd_mux_011_src_valid;                                                              // cmd_mux_011:src_valid -> hex_digits_s1_agent:cp_valid
	wire  [105:0] cmd_mux_011_src_data;                                                               // cmd_mux_011:src_data -> hex_digits_s1_agent:cp_data
	wire          cmd_mux_011_src_ready;                                                              // hex_digits_s1_agent:cp_ready -> cmd_mux_011:src_ready
	wire   [14:0] cmd_mux_011_src_channel;                                                            // cmd_mux_011:src_channel -> hex_digits_s1_agent:cp_channel
	wire          cmd_mux_011_src_startofpacket;                                                      // cmd_mux_011:src_startofpacket -> hex_digits_s1_agent:cp_startofpacket
	wire          cmd_mux_011_src_endofpacket;                                                        // cmd_mux_011:src_endofpacket -> hex_digits_s1_agent:cp_endofpacket
	...
	wire          hex_digits_s1_agent_rp_valid;                                                       // hex_digits_s1_agent:rp_valid -> router_013:sink_valid
	wire  [105:0] hex_digits_s1_agent_rp_data;                                                        // hex_digits_s1_agent:rp_data -> router_013:sink_data
	wire          hex_digits_s1_agent_rp_ready;                                                       // router_013:sink_ready -> hex_digits_s1_agent:rp_ready
	wire          hex_digits_s1_agent_rp_startofpacket;                                               // hex_digits_s1_agent:rp_startofpacket -> router_013:sink_startofpacket
	wire          hex_digits_s1_agent_rp_endofpacket;                                                 // hex_digits_s1_agent:rp_endofpacket -> router_013:sink_endofpacket
	...
	wire          hex_digits_s1_agent_rdata_fifo_src_valid;                                           // hex_digits_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_011:in_0_valid
	wire   [33:0] hex_digits_s1_agent_rdata_fifo_src_data;                                            // hex_digits_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_011:in_0_data
	wire          hex_digits_s1_agent_rdata_fifo_src_ready;                                           // avalon_st_adapter_011:in_0_ready -> hex_digits_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_011_out_0_valid;                                                  // avalon_st_adapter_011:out_0_valid -> hex_digits_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_011_out_0_data;                                                   // avalon_st_adapter_011:out_0_data -> hex_digits_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_011_out_0_ready;                                                  // hex_digits_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_011:out_0_ready
	wire    [0:0] avalon_st_adapter_011_out_0_error;                                                  // avalon_st_adapter_011:out_0_error -> hex_digits_s1_agent:rdata_fifo_sink_error
